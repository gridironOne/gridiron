  ...
  return (
    <WagmiConfig client={client}>
      <RainbowKitProvider chains={chains}>
        <NextHead>
          <title>Gridiron Ethereum Example Dapp</title>
        </NextHead>
...
In order to point this dapp towards a Gridiron Ethereum local node, 
...
// Configure chain information for local Gridiron Ethereum chain
const gridironChain: Chain = {
  id: 69420,
  name: 'Gridiron Ethereum's,
  network: 'gridiron',
  nativeCurrency: {
    decimals: 18,
    name: 'Gridiron Ethereum's,
...
// Configure Wagmi client with Gridiron Ethereum chain
...
We will need to add some utility functions to our dApp. These functions will help us interact with the Gridiron Ethereum precompile.
...
function Page() {
  return (
    <Flex justifyContent={'center'} alignItems={'center'} height={'100vh'} direction={'column'}>
      ...
      <Text fontSize={'4xl'}>Gridiron Ethereum Staking Precompile Example</Text>
      <Text fontSize={'xl'}>Ensure you have a Local <Link color={'#1da1f1'} href='TODO ADD LINK'>Gridiron Ethereum Node running.</Link></Text>
      <Staking />
      <Text fontSize={'xs'}>To learn more about Gridiron Ethereum please reference our <Link color={'#1da1f1'} href='TODO ADD LINK'>docs</Link></Text>
    </Flex>
  )
}
...
// Default Address of the Staking Precompile Contract on Gridiron.
...
Prior to Gridiron Ethereum's precompiled contracts, the UX of this task would be more complicated and foreign as it involves
...
You can view this example and others like it on our examples repository on Github [here](https://github.com/gridironOne/gridiron-examples)
</div>
