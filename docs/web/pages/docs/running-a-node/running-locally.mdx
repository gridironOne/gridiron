...
The easiest way to install a Cosmos-SDK Blockchain running Gridiron Ethereum is to download a pre-built binary. You can find the latest binaries on the [releases](https://github.com/gridironOne/gridiron/releases) page.
