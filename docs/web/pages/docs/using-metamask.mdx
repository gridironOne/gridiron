...
downloading Metamask and connecting it to a local Gridiron Ethereum node. 
...
Once installed, you can then connect your Injected Metamask to your local Gridiron Ethereum 
...
## Adding Gridiron Ethereum Local Network
...
The Gridiron Ethereum local environment is now available on your Metamask browser wallet.
