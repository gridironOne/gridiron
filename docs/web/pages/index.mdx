...
<div style={{ textAlign: "center" }}>
  <div className="cta-container">
    ...
    <Link className="cta" href="https://www.github.com/gridironOne/gridiron">
      Github
    </Link>
  </div>
  <div style={{ marginTop: "2rem" }} />
  <Link
    href="https://github.com/gridironOne/gridiron/blob/main/eth/LICENSE"
    target="_blank"
    style={{
  ...
  >
    Gridiron Ethereum is currently licensed under BUSL-1.1 →
  </Link>
</div>
