...
//go:generate moq -out ./statedb.mock.go -pkg mock ../ GridironStateDB

// NewEmptyStateDB creates a new `StateDBMock` instance.
func NewEmptyStateDB() *GridironStateDBMock {
	mockedGridironStateDB := &GridironStateDBMock{
